...
public class PushBlockAcademy : Academy {
	...
	public float agentRunSpeed; //the "walking speed" of the agents in the scene. every agent will use this setting
	public float agentRotationSpeed; //the "turning speed" of the agents in the scene. every agent will use this setting.
